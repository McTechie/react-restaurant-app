...
//
//   return (
//     <div className="col-12 mt-5" key={leaders.leader.id}>
//       <Media tag="li">
//         <Media left middle>
//             <Media object src={leaders.leader.image} alt={leaders.leader.name} />
//         </Media>
//         <Media body className="ml-5 col-12">
//           <Media heading>{leaders.leader.name}</Media>
//           <h6>{leaders.leader.designation}</h6>
//           <p className="mt-3">{leaders.leader.description}</p>
//         </Media>
//       </Media>
//     </div>
//   );
...
/* Second implementation of RenderLeader() */
